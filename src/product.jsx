    ...
    return(
        <div className="productContainer">
            ...
            <div className="priceSection">
                <p className="currentPrice">{getCurrencySymbol(product.currency)}{product.currentPrice}</p>
                <p className="actualPrice">{getCurrencySymbol(product.currency)}{product.actualPrice}</p>
                <p className="discount">{product.discount}% off</p>
            </div>
            <p className="productStatus">{product.productStatus}</p>
            <div className="sizes"><span>Size</span> {sizeString}</div>
        </div>
    )
}
